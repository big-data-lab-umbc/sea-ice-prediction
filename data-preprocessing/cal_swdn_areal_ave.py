...
days=609
file0='ERA5_daily_SWdn_25N_2020_2021_combined.nc'
df0=Dataset(file0,'r')
wind0=np.array(df0.variables['sfc_lwdn'][:])
...
#np.save('Arctic_regional_mean_swdn',data_mean)

#### write spatial data to nc file ####
ncfile=Dataset('ERA5_daily_SWdn_448x304_2020_2021.nc',mode='w',format='NETCDF4')
...
wind = ncfile.createVariable('sfc_swdn',np.float32,('time','x_dim','y_dim'))
wind.units = 'W m**-2'
wind.missing_value = fill
wind.standard_name = 'surface downwelling shortwave flux' # this is a CF standard name
wind[:]=data
