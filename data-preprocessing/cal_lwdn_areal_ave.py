...
days=609
file0='ERA5_daily_LWdn_25N_2020_2021_combined.nc'
df0=Dataset(file0,'r')
...
#np.save('Arctic_regional_mean_lwdn',data_mean)

#### write spatial data to nc file ####
ncfile=Dataset('ERA5_daily_LWdn_448x304_2020_2021.nc',mode='w',format='NETCDF4')
...
wind = ncfile.createVariable('sfc_lwdn',np.float32,('time','x_dim','y_dim'))
wind.units = 'W m**-2'
