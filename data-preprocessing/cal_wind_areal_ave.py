...
#np.save('Arctic_regional_mean_wind',data_mean)

#### write spatial data to nc file ####
ncfile=Dataset('ERA5_daily_10m_wind_speed_448x304_2020_2021.nc',mode='w',format='NETCDF4')
...
wind = ncfile.createVariable('wind_speed',np.float32,('time','x_dim','y_dim'))
wind.units = 'm/s'
