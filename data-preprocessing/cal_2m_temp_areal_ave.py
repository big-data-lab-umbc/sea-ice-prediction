...
days=609
file0='ERA5_daily_2m_temp_25N_2020_2021_combined.nc'
df0=Dataset(file0,'r')
sh0=np.array(df0.variables['t2m'][:]) #K
...
#np.save('Arctic_regional_2m_temp',data_mean)

#### write spatial data to nc file ####
fill=-999.0
ncfile=Dataset('ERA5_daily_2m_temperature_448x304_2020_2021.nc',mode='w',format='NETCDF4')
...
wind = ncfile.createVariable('t2m',np.float32,('time','x_dim','y_dim'))
wind.units = 'K'
