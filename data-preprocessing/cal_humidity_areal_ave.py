...
days=609
file0='ERA5_daily_near_surface_humidity_25N_2020_2021_combined.nc'
df0=Dataset(file0,'r')
sh0=np.array(df0.variables['specific_humidity'][:]) #kg/kg
...
#np.save('Arctic_regional_mean_humidity',data_mean)

#### write spatial data to nc file ####
fill=-999.0
ncfile=Dataset('ERA5_daily_near_surface_humidity_448x304_2020_2021.nc',mode='w',format='NETCDF4')
...
wind = ncfile.createVariable('specific_humidity',np.float32,('time','x_dim','y_dim'))
wind.units = 'g/kg'
wind.missing_value = fill
wind.standard_name = 'Near-surface specific humidity' # this is a CF standard name
wind[:]=data
