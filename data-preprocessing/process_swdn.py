...
file0=path+'ERA5_hourly_surface_SWdn_25N_ampm_2020_2021.nc'
df1=Dataset(file0,'r')
time=df1.variables['time'][:]
lon=(df1.variables['longitude'][:])
lat=(df1.variables['latitude'][:])
q_raw=np.array(df1.variables['ssrd'][:])
fill=df1.variables['ssrd'].missing_value
...
aa=np.where(new_data<0.0)
new_data[aa]=0.0

#### write data to nc file ####
ncfile=Dataset('ERA5_daily_SWdn_25N_2020_2021_combined.nc',mode='w',format='NETCDF4')
