...
regridder = xe.Regridder(grid_in, ds_out, 'nearest_s2d')
...
plt.savefig('NSIDC_Jan_nearest_s2d.png')
...
plt.savefig('NSIDC_Sept_nearest_s2d.png')

#******  write to nc file
### save data and write it to nc file ###
ncfile=Dataset(diri+'NSIDC_sea_ice_concentration_daily_1deg_nearest_s2d_1979_2019.nc',mode='w',format='NETCDF4')
